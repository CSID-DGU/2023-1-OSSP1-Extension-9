...
model = BertForSequenceClassification.from_pretrained("new_model/KoBERT/fine_tuned_model", num_labels=3)
...
dataset = pd.read_csv('new_model/dataset/after/no_nomal/all_data.csv')

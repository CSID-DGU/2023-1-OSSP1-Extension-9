...
model = BertForSequenceClassification.from_pretrained("new_model/UnSup_Bert_V2/model_outputs", num_labels=4)
tokenizer = BertTokenizer.from_pretrained("new_model/UnSup_Bert_V2/model_outputs")
...
dataset = SentenceDataset('new_model/dataset/after/yes_nomal/all_data.csv')
